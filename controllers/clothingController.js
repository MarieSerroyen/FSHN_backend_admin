...
const create = async (req, res) => {
    try {
        const { name, articleNumber, mapImage, headImage, subImages, sizes, colors, price, materials, category, brand, description } = req.body;

        //Check if fields are empty
        if(!name || !articleNumber || !mapImage || !headImage || !subImages || !sizes || !colors || !price || !materials || !category || !brand || !description) {
